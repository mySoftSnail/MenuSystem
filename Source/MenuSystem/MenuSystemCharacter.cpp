...
void AMenuSystemCharacter::CreateGameSession()
{
	...
	// the online session interface will now have our delegate - added to its delegate list.
	OnlineSessionInterface->AddOnCreateSessionCompleteDelegate_Handle(CreateSessionCompleteDelegate);
	// and once we've created a session, then our callback function(OnCreateSessionComplete) which we've bound to this delegate will be called.
	// this is where we will verify that our session has indeed been created.
...
void AMenuSystemCharacter::JoinGameSession()
{
	...
	// since we're using presence, we have to specify that in our search settings. it says the query to use for finding matching servers where using presence.
...
void AMenuSystemCharacter::OnJoinSessionComplete(FName SessionName, EOnJoinSessionCompleteResult::Type Result)
{
	...
	FString Address; // the address we need to travel to using ClientTravel
